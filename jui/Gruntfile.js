module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		concat : {
			...
			lib : {
				src : ['lib/document-register-element.js', 'lib/handlebars.runtime-v3.0.3.js', 'lib/helper.js', 'lib/expr-eval.min.js', 'lib/popper.js', 'lib/pep.min.js', 'lib/doubletap.js'],
